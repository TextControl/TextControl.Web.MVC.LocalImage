...
}s.prototype.closing=function(){var y=this;
document.removeEventListener("fileListReceived",this.fileListReceivedHandlerBound);
if(this.dialogData.dialogResult){var z=document.getElementById("txOFDTxtFileName");
var x=z.value;
if(x&&(x!=="")){b.sendCommand(this.command,this.fileType,w(),0,x);
}}function w(){return(y.fileType==b.FileType.DataBase)?y.subFileType:0;
}};
...
}function u(A){var B=document.getElementById("txOFDTblFilesAndFolders");
var E=document.getElementById("txOFDSelFileType");
for(var z=B.children.length-1;
z>=0;
--z){var w=B.children[z];
if(w.tagName==="TR"){B.removeChild(w);
}}A.subFileType=parseInt(E.value,10);
var y=j(A.fileType,A.subFileType);
var x=i(y,A.fileNames);
A.dirNames.forEach(function(F){var J=document.createElement("TR");
var H=document.createElement("TD");
var I=document.createElement("TD");
var G=document.createElement("IMG");
J.classList.add("txOFDItemTypeDir");
G.alt=A.altTexts.dirName;
G.src=A.imageDataURLs.dir;
I.textContent=F;
H.appendChild(G);
J.appendChild(H);
J.appendChild(I);
...
x.forEach(function(J){var I=document.createElement("TR");
var G=document.createElement("TD");
var H=document.createElement("TD");
var F=document.createElement("IMG");
I.classList.add("txOFDItemTypeFile");
F.alt=A.altTexts.fileName;
F.src=A.imageDataURLs.file;
H.textContent=J;
G.appendChild(F);
I.appendChild(G);
I.appendChild(H);
...
function C(G){var F=document.getElementById("btnOK_"+A.dialogContainerID);
var I=k(G.target);
if(I){a("#txOFDTblFilesAndFolders tr.selected").removeClass("selected");
I.classList.add("selected");
var J=document.getElementById("txOFDTxtFileName");
var H=I.children[1];
if(p(I)){h(F,true);
J.value=H.textContent;
}else{if(n(I)){h(F,true);
J.value="";
}}}}function D(G){var F=document.getElementById("btnOK_"+A.dialogContainerID);
var I=k(G.target);
if(I){var H=I.children[1];
if(n(I)){h(F,false);
q(H.textContent);
}else{if(p(I)){r(A,H.textContent);
}}}}a("#txOFDTblFilesAndFolders tr").click(C);
a("#txOFDTblFilesAndFolders tr").dblclick(D);
...
b.setRibbonStrings=function(){var z=b.ribbonStringResources;
for(var y in z){if(z.hasOwnProperty(y)){if(typeof z[y]==="string"){z[y]=z[y].replace(/\r?\n/g,"<br>");
}}}var w=document.getElementById("tabFile");
w.textContent=w.dataset.text=z.RIBBON_MNU_FILE_TITLE;
w=document.getElementById("tabDefault");
w.textContent=w.dataset.text=z.RIBBON_TAB_HOME_TITLE;
w=document.getElementById("tabInsert");
w.textContent=w.dataset.text=z.RIBBON_TAB_INSERT_TITLE;
w=document.getElementById("tabPageLayout");
w.textContent=w.dataset.text=z.RIBBON_TAB_PAGE_LAYOUT_TITLE;
w=document.getElementById("tabReports");
w.textContent=w.dataset.text=z.RIBBON_TAB_REPORTS_TITLE;
w=document.getElementById("tabView");
w.textContent=w.dataset.text=z.RIBBON_TAB_VIEW_TITLE;
w=document.getElementById("tabProofing");
w.textContent=w.dataset.text=z.RIBBON_TAB_PROOF_TITLE;
w=document.getElementById("tabTableLayout");
w.textContent=w.dataset.text=z.RIBBON_TAB_TBL_LAYOUT_TITLE;
b.adaptRibbonTabWidths();
var x=document.getElementById("tabFile");
x.textContent=z.RIBBON_MNU_FILE_TITLE;
e("fileMnuItemNew",z.RIBBON_MNU_FILE_NEW);
e("fileMnuItemOpen",z.RIBBON_MNU_FILE_OPEN);
e("fileMnuItemSave",z.RIBBON_MNU_FILE_SAVE);
e("fileMnuItemSaveAs",z.RIBBON_MNU_FILE_SAVE_AS);
e("fileMnuItemPrintToPDF",z.RIBBON_MNU_FILE_PRINT);
e("fileMnuItemOptions",z.RIBBON_MNU_FILE_OPTIONS);
r(z);
